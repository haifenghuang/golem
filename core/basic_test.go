...
func TestInt(t *testing.T) {
	...
	ok(t, val, err, Int(1))
	val, err = Int(3).Sub(MakeFloat(2.0))
	...
	ok(t, val, err, Int(6))
	val, err = Int(3).Mul(MakeFloat(2.0))
	...
	ok(t, val, err, Int(1))
	val, err = Int(3).Div(MakeFloat(2.0))
	...
	val, err = Int(3).Div(MakeFloat(0.0))
	fail(t, val, err, "DivideByZero")

	v1, err := Int(3).Add(Int(2))
	ok(t, v1, err, Int(5))
	v1, err = Int(3).Add(MakeFloat(2.0))
...
func TestFloat(t *testing.T) {
	...
	z, err = MakeFloat(1.0).Eq(Int(1))
	ok(t, z, err, TRUE)

	val, err := a.Negate()
	ok(t, val, err, MakeFloat(-0.1))

	val, err = MakeFloat(3.3).Sub(Int(2))
	...
	val, err = MakeFloat(3.3).Mul(Int(2))
	ok(t, val, err, MakeFloat(float64(3.3)*float64(int64(2))))
	...
	val, err = MakeFloat(3.3).Div(Int(2))
	ok(t, val, err, MakeFloat(float64(3.3)/float64(int64(2))))
	...
	val, err = MakeFloat(3.3).Div(Int(0))
	fail(t, val, err, "DivideByZero")
	val, err = MakeFloat(3.3).Div(MakeFloat(0.0))
	fail(t, val, err, "DivideByZero")

	v1, err := MakeFloat(3.3).Add(Int(2))
